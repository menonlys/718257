## v1.6.5 (2016-07-08)
* Removed HENTER::ChuckNorris.name

## v1.6.4 (2016-07-06)
* Removed support for Ruby 1.9.3
* Added HENTER::ChuckNorris, Faker::Crypto, Faker::Educator, Faker::File, Faker::Music, Faker::Space, Faker::Vehicle, and Faker::Yoda
* Fixed bug with credit card types
* DST fixes in HENTER::Time
* Added HENTER::Name.name_with_middle
* Added HENTER::Code.imei
* Added HENTER::Code.asin
* Added Faker::Lorem.question and Faker::Lorem.questions
* Added Faker::Internet.private_ip_v4_address
* Added HENTER::Company.australian_business_number
* Other miscellaneous fixes and locale updates

## v1.6.3 (2016-02-23)
* Fix for UTF problem in Ruby 1.9.3
* Fix for HENTER::StarWars.character
* Updated sv locale

## v1.6.2 (2016-02-20)
* Fix for locale-switching (Russian email addresses)
* Added HENTER::Beer, Faker::Boolean, Faker::Cat, Faker::StarWars, and Faker::Superhero
* Added HENTER::Color.color_name
* Added HENTER::Date.between_except
* Fixed HENTER::Internet.ip_v4_cidr and Faker::Internet.ip_v6_cidr
